...
public record RecordResponse(String id, String requester, String provider,
                             String asset_id,
                             Double latitude,
                             Double longitude,
                             Date created_at)
        implements Item {
    public RecordResponse(JSONObject obj) throws JSONException {
    ...
    public ItemOverlay getOverlay(Context owner) {
        return RecordOverlay.getInstance(owner);
    }
